...
Revision ID: 476d117d49e3
Revises: d1fb61817498
Create Date: 2022-06-04 17:14:42.260150
...
revision = '476d117d49e3'
down_revision = 'd1fb61817498'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    op.add_column('artist', sa.Column('look_venue', sa.Boolean(), nullable=False))
    op.add_column('artist', sa.Column('seek_description', sa.String(length=400), nullable=False))
    ...
    op.alter_column('artist', 'facebook_link',
               existing_type=sa.VARCHAR(length=120),
               nullable=False)
    op.add_column('venue', sa.Column('genres', sa.String(length=255), nullable=False))
    op.add_column('venue', sa.Column('website_link', sa.String(length=120), nullable=False))
    op.add_column('venue', sa.Column('look_talent', sa.Boolean(), nullable=False))
    op.add_column('venue', sa.Column('seek_description', sa.String(length=400), nullable=False))
...
def downgrade():
    ...
    op.drop_column('venue', 'look_talent')
